      ...
      <div className="page-wrapper max-w-5xl mx-auto px-4 py-12">
        ...
        {stories.length === 0 ? (
          <div className="glass p-16 text-center">
            ...
            <p className="text-white/40">Success stories coming soon. Be one of the first!</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-display text-lg font-bold text-white">{story.coupleName}</h3>
                      {story.isFeatured && (
                    ...
                    {story.date && (
                      <p className="text-white/30 text-xs mb-3">Married {formatDate(story.date)}</p>
                    )}
                    <p className="text-white/60 text-sm leading-relaxed line-clamp-4">{story.story}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="mt-12 glass p-8 text-center">
          <h2 className="font-display text-2xl font-bold text-white mb-3">Your Story Could Be Next</h2>
          <p className="text-white/50 mb-6">Join thousands of verified members and find your perfect life partner.</p>
